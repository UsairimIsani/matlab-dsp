...
[bh,ah]=butter(6,[125 175]/500); %Filter coefficients 6 is order 500 is fs/2
[b1,a1]=butter(6,[75 125]/500); %Filter coefficients
[hh,wh]=freqz(bh,ah,length(t),'whole'); %Frequency response
[h1,w1]=freqz(b1,a1,length(t),'whole'); %Frequency response
%Filter operation
yh=filtfilt(bh,ah,x);
y1=filtfilt(b1,a1,x);
%Plotting
